...
public class StringUtil {
	...
	public static String dateTypeSubstring(String date, String dmt) throws Exception{
		...
		String[] dateArray = dateValue.split(dmt);
		if (dateArray.length > 0){
			int length = dateArray.length;
			dateValue = "";
			StringBuffer sb = new StringBuffer();
			for (int i = 0 ; i < length; i++)	sb.append(dateArray[i]); 
	 ...
	 * @return
	 */
	public static String numberFixFormat(String s, int length, String c){
		String r = "";
